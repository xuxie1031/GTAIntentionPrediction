...
class ObsEmbedLayer(nn.Module):
    def __init__(self, emb_dim, in_channels=4, nc=3, kernel_size=1, stride=1):
...
class STGCN3DGEPModel(nn.Module):
    def __init__(self, args, device=None, activation='relu', batch_norm=True):
        ...
        self.emb = ObsEmbedLayer(args.emb_dim, args.in_channels, args.nc, args.emb_kernel_size)
    ...
    def forward(self, x, A, one_hots_c_obs_seq, one_hots_c_pred_seq):
        N, _, _, _, V = x.size()
